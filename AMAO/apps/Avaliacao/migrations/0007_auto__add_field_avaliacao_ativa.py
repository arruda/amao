...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Avaliacao.ativa'
        db.add_column('Avaliacao_avaliacao', 'ativa', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Avaliacao.ativa'
        db.delete_column('Avaliacao_avaliacao', 'ativa')
