...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TemplateAvaliacao.turma'
        db.add_column('Avaliacao_templateavaliacao', 'turma', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='templateAvaliacoes', to=orm['Turma.Turma']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TemplateAvaliacao.turma'
        db.delete_column('Avaliacao_templateavaliacao', 'turma_id')
