...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Avaliacao.templateAvaliacao'
        db.add_column('Avaliacao_avaliacao', 'templateAvaliacao', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='avaliacoes', to=orm['Avaliacao.TemplateAvaliacao']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Avaliacao.templateAvaliacao'
        db.delete_column('Avaliacao_avaliacao', 'templateAvaliacao_id')
