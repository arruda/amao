...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Avaliacao.data_inicio'
        db.add_column('Avaliacao_avaliacao', 'data_inicio', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 5, 2, 15, 18, 57, 172987)), keep_default=False)

        # Adding field 'Avaliacao.data_termino'
        db.add_column('Avaliacao_avaliacao', 'data_termino', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 5, 2, 15, 19, 8, 323024)), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Avaliacao.data_inicio'
        db.delete_column('Avaliacao_avaliacao', 'data_inicio')

        # Deleting field 'Avaliacao.data_termino'
        db.delete_column('Avaliacao_avaliacao', 'data_termino')
