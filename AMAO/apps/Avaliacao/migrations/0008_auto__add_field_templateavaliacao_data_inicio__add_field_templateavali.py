...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TemplateAvaliacao.data_inicio'
        db.add_column('Avaliacao_templateavaliacao', 'data_inicio', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 2, 23, 17, 54, 48, 613084)), keep_default=False)

        # Adding field 'TemplateAvaliacao.data_termino'
        db.add_column('Avaliacao_templateavaliacao', 'data_termino', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 2, 23, 17, 55, 1, 353081)), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TemplateAvaliacao.data_inicio'
        db.delete_column('Avaliacao_templateavaliacao', 'data_inicio')

        # Deleting field 'TemplateAvaliacao.data_termino'
        db.delete_column('Avaliacao_templateavaliacao', 'data_termino')
