...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('Avaliacao_avaliacao', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('titulo', self.gf('django.db.models.fields.CharField')(max_length=250)),
            ('aluno', self.gf('django.db.models.fields.related.ForeignKey')(related_name='avaliacoes', to=orm['Aluno.Aluno'])),
            ('slug', self.gf('django.db.models.fields.SlugField')(db_index=True, max_length=50, blank=True)),
        ))
        db.send_create_signal('Avaliacao', ['Avaliacao'])


    def backwards(self, orm):
        
        # Deleting model 'Avaliacao'
        db.delete_table('Avaliacao_avaliacao')
