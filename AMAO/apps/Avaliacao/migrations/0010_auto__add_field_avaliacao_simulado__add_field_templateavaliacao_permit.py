...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Avaliacao.simulado'
        db.add_column('Avaliacao_avaliacao', 'simulado', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'TemplateAvaliacao.permite_simulado'
        db.add_column('Avaliacao_templateavaliacao', 'permite_simulado', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Avaliacao.simulado'
        db.delete_column('Avaliacao_avaliacao', 'simulado')

        # Deleting field 'TemplateAvaliacao.permite_simulado'
        db.delete_column('Avaliacao_templateavaliacao', 'permite_simulado')
