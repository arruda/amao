...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'TemplateAvaliacao.active'
        db.delete_column('Avaliacao_templateavaliacao', 'active')

        # Adding field 'TemplateAvaliacao.ativa'
        db.add_column('Avaliacao_templateavaliacao', 'ativa', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'TemplateAvaliacao.active'
        db.add_column('Avaliacao_templateavaliacao', 'active', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'TemplateAvaliacao.ativa'
        db.delete_column('Avaliacao_templateavaliacao', 'ativa')
