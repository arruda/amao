...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('Professor_professor', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('usuario', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], unique=True)),
        ))
        db.send_create_signal('Professor', ['Professor'])

        # Adding model 'Monitor'
        db.create_table('Professor_monitor', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('usuario', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], unique=True)),
            ('matricula', self.gf('django.db.models.fields.CharField')(unique=True, max_length=250)),
            ('materia', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Materia.Materia'], unique=True)),
            ('slug', self.gf('django.db.models.fields.SlugField')(db_index=True, max_length=50, blank=True)),
        ))
        db.send_create_signal('Professor', ['Monitor'])


    def backwards(self, orm):
        
        # Deleting model 'Professor'
        db.delete_table('Professor_professor')

        # Deleting model 'Monitor'
        db.delete_table('Professor_monitor')
