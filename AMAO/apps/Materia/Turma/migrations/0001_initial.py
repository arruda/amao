...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('Turma_turma', (
            ...
            ('professor', self.gf('django.db.models.fields.related.ForeignKey')(related_name='turmas', to=orm['Professor.Professor'])),
            ('materia', self.gf('django.db.models.fields.related.ForeignKey')(related_name='turmas', to=orm['Materia.Materia'])),
            ('slug', self.gf('django.db.models.fields.SlugField')(db_index=True, max_length=50, blank=True)),
        ))
        db.send_create_signal('Turma', ['Turma'])

        # Adding M2M table for field alunos on 'Turma'
        db.create_table('Turma_turma_alunos', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('turma', models.ForeignKey(orm['Turma.turma'], null=False)),
            ('aluno', models.ForeignKey(orm['Aluno.aluno'], null=False))
        ))
        db.create_unique('Turma_turma_alunos', ['turma_id', 'aluno_id'])


    def backwards(self, orm):
        
        # Deleting model 'Turma'
        db.delete_table('Turma_turma')

        # Removing M2M table for field alunos on 'Turma'
        db.delete_table('Turma_turma_alunos')
